<section className="hero-section">
  <div className="hero-content" style={{
    ...
    <div className="hero-buttons" style={{
      ...
      <button onClick={() => handleNavigation('offer')} className="btn-primary" style={{
        backgroundColor: '#fff',
        color: '#3b0066',
        padding: '0.9rem 2rem',
        borderRadius: '8px',
      ...
      <button onClick={() => handleNavigation('app')} className="btn-secondary" style={{
      ...
      <button onClick={() => handleNavigation('contact')} className="btn-accent" style={{
